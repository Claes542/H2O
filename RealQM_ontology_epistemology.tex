...
choice, not a necessity. It is worth stressing that this is not a \emph{hidden-variable} theory, and that the
demand for ontology --- often conflated with the demand for hidden variables --- is a distinct thing: a
hidden-variable theory keeps the amplitude and adds unobserved parameters beneath it (as de~Broglie--Bohm does),
whereas RealQM \emph{replaces} the amplitude with real charge in three-dimensional space, so that nothing is
hidden --- the densities are the reality itself. One may therefore reject hidden variables and still insist, with
Schr\"odinger and Einstein, that a theory say what is there. The configuration-space step was mathematically convenient and interpretively fatal;
