...
\title{Ontology versus Epistemology in Quantum Mechanics:\\
\large The Surrender of 1926}
...
rest of his life pressing the point --- through the Solvay debates and, in 1935, through the EPR argument --- that
...
moreover from an object, the wave function on $3N$-dimensional space, that Kohn observed is not a legitimate
...
RealQM takes the second horn concretely. The real things are charge densities in ordinary three-dimensional
...
Coulomb energy. That is the programme of RealQM, taken up elsewhere; the point here is only that it exists, that
