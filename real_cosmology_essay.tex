...
Now the other mirror force. The matter that Coulomb has built carries \emph{energy} --- and energy is what
gravitates. (A word on this below.) Newton's law, acting on that energy, does at the large scale what Coulomb does
at the small: it pulls things together. Because gravity's source can, in effect, gather in two ways --- regions
that draw matter in and regions matter is pushed from --- the universe organises into the filaments and clusters
of the \textbf{cosmic web}, threaded by great empty \textbf{voids} that behave as though something were pushing
them apart. That ``something'' is what astronomers call \textbf{dark energy}; here it is not a new substance but
the other face of ordinary gravity. No dark matter, no dark energy added by hand --- just the two sides of Newton's
force.
...
nuclei, atoms and chemistry; and Newton, acting on the energy of all that matter, gathering it into stars, galaxies
and the cosmic web. Two old laws, two constants --- and the simplest question of all left standing: is nature
