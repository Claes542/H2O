...
technical article,} C.\ Johnson, \emph{A Coulomb--Newton Cosmology: Based on a Proton--Electron Model
(RealQM/RealNucleus)}, \emph{and the treatise} \emph{Real Quantum Mechanics} \emph{($\sim$340 pp), both free from
