...
a fact about this article, not about RealQM, and the route out is specific enough to state. A
complex density has a phase, so $J\propto\Im(\psi^*\grad\psi)$ ceases to vanish and a current exists
as an object; that removes the first obstacle. It does not remove the second, since a Hamiltonian
