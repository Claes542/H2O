...
material class it can describe.} That is the substantive cost of the construction if one wants metals after
all.
...
the pathology disappears as soon as real ions are present: the alkali lattice constants are the same framework on the same physics, with
