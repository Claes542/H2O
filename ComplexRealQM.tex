...
$\omega=E_2-E_1$; but the physics is the charge moving in space, not the abstract superposition.) The
atomic-spectrum consequences --- the levels, the selection rules read as geometry, and helium's lines ---
are developed in the companion \cite{Spectra}.
