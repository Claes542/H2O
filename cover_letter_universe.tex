...
\noindent
\begin{tabular}{@{}ll@{}}
\textbf{Manuscript:} & A Proton--Electron Cosmology: RealQM and Newtonian Gravitation \\
                     & from a Single Electric-Potential Seed \\
...
\medskip
I am pleased to submit the manuscript \emph{A Proton--Electron Cosmology: RealQM and Newtonian Gravitation from a
Single Electric-Potential Seed} for consideration as an Article in \emph{Universe}.
...
atoms (the RealQM\,/\,RealNucleus program), and the ordinary energy/mass density of that Coulombic matter sources
an emergent Newtonian gravitation whose positive and negative curvature sectors separate into the cosmic web and a
repulsive (dark-energy-like) component. The model reproduces a helium mass fraction near $Y\approx0.25$ as a
consistency check.
