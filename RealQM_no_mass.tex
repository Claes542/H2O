...
dissolving a shared present.\footnote{This is the standpoint of \emph{Many-Minds Relativity}~\cite{MMR}, which
...
\bibitem{RealQM} C.~Johnson, \emph{Real Quantum Mechanics}, RealMolecule gallery, and references therein.
...
\bibitem{MMR} C.~Johnson, \emph{Many-Minds Relativity} (2011).
